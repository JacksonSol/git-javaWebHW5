...
public class HW5Test {
    ...
    public void testCase1() {
        ...
        driver.findElement(By.xpath("//input[@name='USER_LOGIN']")).sendKeys("solsol");
        driver.findElement(By.xpath("//input[@name='USER_PASSWORD']")).sendKeys("solsol297");
        driver.findElement(By.xpath("//button[@name='Login']")).click();
        String s = driver.findElement(By.xpath("//a[@class='nav-link text-truncate pt-0']")).getText();
        assertTrue(s.equals("Евгений"));
    ...
    @Test
    @DisplayName("Тест-кейс №3: Проверка правильности отображения телефонного номера на главной странице сайта")
    ...
    public void testCase6() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@name='NAME']")).clear();
        driver.findElement(By.xpath("//input[@name='NAME']")).sendKeys("Евгений");
        driver.findElement(By.xpath("//input[@name='SECOND_NAME']")).clear();
        driver.findElement(By.xpath("//input[@name='SECOND_NAME']")).sendKeys("Сол");
        driver.findElement(By.xpath("//input[@name='LAST_NAME']")).clear();
        driver.findElement(By.xpath("//input[@name='LAST_NAME']")).sendKeys("Сол");
        driver.findElement(By.xpath("//input[@name='NEW_PASSWORD']")).clear();
        js.executeScript("window.scrollTo(0, 700)");
        Thread.sleep(1000);
        driver.findElement(By.xpath("//input[@name='save']")).click();
